...
class Chat extends MY_Controller {
	...
	public function delete_chat(){
		...
		if($buddy != '') {
			...
			$del_msg = $this->user->delete_friend($logged_user, $buddy); 
	...
	public function lastseen_update(){
...
*/
	...
	public function checkfriend(){
		$user_id 	= $this->authentication->read('identifier');
		$buddy 		= $this->input->post('friendid');

		$check = $this->message->findfriend($user_id, $buddy);

		if(!$check){
			$this->message->addtofriendlist($user_id,$buddy);
			$response = array(
				'success' => false,
				'message' => 'User Added'
				);
