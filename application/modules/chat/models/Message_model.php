...
class Message_model extends MY_Model{
	...
	public function findfriend($user_id, $friendid){
	...
	public function addtofriendlist($logged_user,$buddy){
		$data1 = array('friend_id' => $buddy, 'user_id'=>$logged_user);
		$query = $this->db->insert('contact_list',$data1);
